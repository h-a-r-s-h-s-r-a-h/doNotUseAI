...
export function ChatInterface({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (backendResponse.extracted_text) {
      systemResponse.content = `Extracted content:\n${backendResponse.extracted_text}\n\nAnalysis:\n${backendResponse.response}`;
    }
                      ...
                      <div className="mt-2 border border-[#7B4DFF] border-opacity-40 rounded p-2">
                        ...
                        {message.attachment.type === "audio" && message.attachment.previewUrl && (
                          <div className="mt-1">
                            ...
                            />
                            <p className="text-xs text-gray-400 mt-1">Audio will be transcribed and analyzed</p>
                          </div>
                        )}
